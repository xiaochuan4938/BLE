...
{
    if ((self = [super initWithFrame:CGRectMake(origin.x, origin.y, 250, 250)]))
	{
		UIImageView *wheel = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"beLightColorPicker"]];
		wheel.contentMode = UIViewContentModeTopLeft;
		wheel.frame = CGRectMake(0, 0, 250, 250);
